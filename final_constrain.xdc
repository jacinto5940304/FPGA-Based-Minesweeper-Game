...
set_property PACKAGE_PIN T18 [get_ports _BTNU]
    set_property IOSTANDARD LVCMOS33 [get_ports _BTNU]
set_property PACKAGE_PIN U17 [get_ports _BTND]
    set_property IOSTANDARD LVCMOS33 [get_ports _BTND]
set_property PACKAGE_PIN T17 [get_ports _BTNR]
    set_property IOSTANDARD LVCMOS33 [get_ports _BTNR]
set_property PACKAGE_PIN W19 [get_ports _BTNL]
    set_property IOSTANDARD LVCMOS33 [get_ports _BTNL]
